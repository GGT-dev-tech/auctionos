...
export const PropertyEstimatesComps: React.FC<Props> = ({ property }) => {
    ...
    return (
        <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700 h-full flex flex-col">
            ...
            {/* ARV Modal */}
            <Modal isOpen={arvOpen} onClose={() => setArvOpen(false)} title="Comparable Sales Report" size="3xl">
            ...
            {/* Rent Modal */}
            <Modal isOpen={rentOpen} onClose={() => setRentOpen(false)} title="Comparable Rental Report" size="3xl">
                <div className="space-y-5 p-1">
